      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="col-span-1">
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="text-xl font-serif font-black text-white tracking-tight leading-none">
                BOOK MY
              </span>
              <span className="text-lg font-serif font-light text-stone-400 tracking-[0.1em] leading-none">
                TRACK
              </span>
            </div>
          </div>
          ...
          <p className="text-sm leading-relaxed mb-8">
            Explore the untamed beauty of nature with India's most exclusive tracking
            and wildlife expedition platform.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            <li>
              <button onClick={() => navigate('/destinations')} className="hover:text-white transition-colors">
                Safari Zones
              </button>
            </li>
            <li>
              <button onClick={() => navigate('/weddings')} className="hover:text-white transition-colors">
                Weddings
              </button>
            </li>
            <li>
              <button onClick={() => navigate('/places')} className="hover:text-white transition-colors">
                Places to Visit
              </button>
            </li>
            <li>
        ...
        <div>
          ...
          <p className="text-sm mb-4">
            Subscribe for sightings reports and expedition invites.
          </p>
