    ...
    <div className="pt-32 pb-24 px-6 animate-in fade-in duration-500">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <span className="text-stone-400 text-[10px] font-bold uppercase tracking-[0.4em] mb-4 block">
          ...
          <p className="text-stone-500 max-w-2xl mx-auto leading-relaxed">
            From the world-famous grasslands of Dhikala to the dense Sal forests of Bijrani.
            Each zone in Corbett offers a unique wildlife perspective and distinct ecosystem.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {DESTINATIONS.map((dest) => (
            <div
              key={dest.id}
              className="group relative overflow-hidden rounded-3xl aspect-[16/10] bg-stone-200 cursor-pointer"
              onClick={() =>
            ...
            >
              ...
              <div className="absolute bottom-10 left-10 right-10">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-white text-sm font-bold border-b border-white/50 pb-0.5 group-hover:border-white transition-all">
                    View Zone Details
                  </span>
                </div>
              </div>
